...
```{r}
outliers <-boxplot(df_no_duplicates$`City FE` ~ df_no_duplicates$`# Cylinders`, data = df_no_duplicates,xlab="# Cylinders", ylab="City FE")$out
print(outliers)
...
```{r}
boxplot(df_no_duplicates$`City FE` ~ df_no_duplicates$`# Gears`, data = df_no_duplicates,xlab="# Gears", ylab="City FE")$out
...
```{r}
boxplot(df_no_duplicates$`City FE` ~ df_no_duplicates$`Engine Displacement`, data = df_no_duplicates,xlab="Engine Displacement", ylab="City FE")$out
```
